...
public class TSC6530 {
        ...
        public bool csState; // Chip select
        public bool readState; // Read pin input
        public bool writeState; // Write pin input
        public byte addressInput; // Select internal register
        
        // "Back"
        public bool ext1State; // Ext 1 pin input
        public bool ext2State; // Ext 2 pin input
        public bool ext3State; // Ext 3 pin input
        public bool cntState; // CNT pin input
        public bool taOutState; // TA pin output
        public bool tbOutState; // TB pin output
        public bool irqState; // IR pin output
        public bool rstState; // RES (reset) pin input
        public bool clkState; // Clock pin input
        ...
        public void LogicUpdate(){
            ...
            if(writeState && csState && !lastWrite){
                write();
            }
        ...
        byte readExt(){
            ...
            data |= (byte)(ext1State ? 1 : 0);
            data |= (byte)(ext2State ? 2 : 0);
            data |= (byte)(ext3State ? 4 : 0);
