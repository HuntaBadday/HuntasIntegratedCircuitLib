...
public class TSC_LWC33 {
    ...
    // CPU IO
    public ushort dataBusInput; // Input to the CPU's data bus
    public ushort dataBusOutput; // Output from the CPU's data bus
    public ushort addressOutput; // Address output from the CPU
    public ushort segmentOutput; // Segment output from the CPU
    public ushort deviceBusInput; // Input to the CPU's device data bus
    public ushort deviceBusOutput; // Output from the CPU's device data bus
    public ushort deviceAddrOutput; // Device address output from the CPU
    
    public bool readState; // CPU's memory bus read pin state
    public bool writeState; // CPU's memory bus write pin state
    public bool devReadState; // CPU's device bus read pin state
    public bool devWriteState; // CPU's device bus write pin state
    
    public bool setCarryState; // CPU's set carry pin input
    public byte auxState; // CPU's aux pins input; AUX pins 0 - 3 are bits 0 - 3
    public byte interruptPinStates; // CPU's interrupt pins input; Interrupt pins 0 - 3 are bits 0 - 3
    
    public bool clockState; // CPU clock input
    public bool pauseState; // CPU pause input
    public bool syncState; // CPU sync output
    public bool resetState; // CPU reset input
